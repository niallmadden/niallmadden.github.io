...
\title{Inspiring Linear Algebra Topics Using Real-Life Applications}
\author{Amanda Harsy, Marie Snipes, Michael Smith, Heather Moon, Tom Asaki} %Presenting author only
\address{Lewis University, Kenyon College, Lewis University, Washington State University, Washington State University} % Affiliation of presenting author
\email{harsyram@lewisu.edu, snipesm@kenyon.edu, heather.annette.moon@gmail.com, tasaki@wsu.edu} % Email address of presenting author only

\maketitle

There are many rich and beautiful real-life, cutting-edge applications to Linear Algebra.  Many of these applications can be used to inspire the development and understanding of central concepts in a first-year Linear Algebra course: span, linear transformations, eigenvectors and eigenvalues, and the invertible matrix theorem.  In this talk, we will share an application approach to designing a first-semester linear algebra course.  We will discuss IMAGEMath modules and other activities which connect linear algebra concepts to applications such as computer graphics, predictive modeling, brain image reconstruction from CAT scan radiographs, and more.
...
\emph{This is joint work and presentation with Amanda Harsy, Marie Snipes, Michael Smith, Heather Moon, and Tom Asaki}.

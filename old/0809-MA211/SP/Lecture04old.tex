...
\frame{
\emph{Hint for Exer 4.2:}  Recall \Emph{Binomial Expansion}
\[ 
...
f'(x)
=
\frac{u(x) v'(x)  -  u'(x) v(x)}{ \big(v(x)\big)^2}.
\]
\end{block}
...
\frame{
%\Bf{(See Adams, Section 2.4)}


We could differentiate the trigonometrical functions \eq{\cos} and \eq{\sin}
